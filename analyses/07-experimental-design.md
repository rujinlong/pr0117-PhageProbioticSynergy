...
Based on Notion Research Master Plan Section 11 (Experimental Design
Philosophy):

**Germany (Lab Validation)**: - Phage isolation & characterization -
Proxy strain validation (Module 05) - In vitro synergy tests - Mechanism
exploration (Module 06)

**China (Animal Trials)**: - Formal animal experiments - Clinical
trials - Commercialization preparation
...
**Factors**: - Treatment (4 levels: Control, Phage, Probiotic,
Synergy) - Time (5 levels: Day 0, 7, 14, 21, 35) - Block (3 levels: Rack
...
- **Germany**: Animal experimentation approval is slow → focus on in
  vitro
...
- **Germany**: Application to local animal ethics committee (需时 2-3
  月)
