...
- [<span class="toc-section-number">2</span> Read upstream
  ...
  - [<span class="toc-section-number">2.1</span> 1.
    Objective](#1-objective)
  - [<span class="toc-section-number">2.2</span> 2. Trial Design (China
    Context)](#2-trial-design-china-context)
    - [<span class="toc-section-number">2.2.1</span> 2.1 Regulatory
      Landscape](#21-regulatory-landscape)
    - [<span class="toc-section-number">2.2.2</span> 2.2 Trial
      Sites](#22-trial-sites)
  - [<span class="toc-section-number">2.3</span> 3. Data Collection &
    Management](#3-data-collection--management)
    - [<span class="toc-section-number">2.3.1</span> 3.1 Variables to
      Track](#31-variables-to-track)
  - [<span class="toc-section-number">2.4</span> 4. Statistical
    Analysis](#4-statistical-analysis)
    - [<span class="toc-section-number">2.4.1</span> 4.1 Mixed-Effects
      Model](#41-mixed-effects-model)
- [<span class="toc-section-number">3</span> Template: Linear mixed
  model for FCR](#template-linear-mixed-model-for-fcr)
- [<span class="toc-section-number">4</span>
  library(nlme)](#librarynlme)
- [<span class="toc-section-number">5</span> ](#section)
- [<span class="toc-section-number">6</span> model_fcr \<-
  lme(](#model_fcr---lme)
- [<span class="toc-section-number">7</span> fixed = FCR ~ treatment \*
  day,](#fixed--fcr--treatment--day)
- [<span class="toc-section-number">8</span> random = list(pen = ~1,
  bird = ~1),](#random--listpen--1-bird--1)
- [<span class="toc-section-number">9</span> data =
  trial_data,](#data--trial_data)
- [<span class="toc-section-number">10</span> correlation = corAR1(form
  = ~day \| bird)](#correlation--corar1form--day--bird)
- [<span class="toc-section-number">11</span> )](#section-1)
- [<span class="toc-section-number">12</span> ](#section-2)
- [<span class="toc-section-number">13</span>
  summary(model_fcr)](#summarymodel_fcr)
- [<span class="toc-section-number">14</span>
  anova(model_fcr)](#anovamodel_fcr)
  - [<span class="toc-section-number">14.1</span> 5. Results
    Visualization](#5-results-visualization)
    - [<span class="toc-section-number">14.1.1</span> 5.1 FCR Over
      Time](#51-fcr-over-time)
- [<span class="toc-section-number">15</span> ggplot(trial_data, aes(x =
  day, y = FCR, color = treatment, group = pen))
  +](#ggplottrial_data-aesx--day-y--fcr-color--treatment-group--pen-)
- [<span class="toc-section-number">16</span> stat_summary(geom =
  “line”, fun = mean) +](#stat_summarygeom--line-fun--mean-)
- [<span class="toc-section-number">17</span> stat_summary(geom =
  “errorbar”, fun.data = mean_se, width = 2)
  +](#stat_summarygeom--errorbar-fundata--mean_se-width--2-)
- [<span class="toc-section-number">18</span> theme_minimal()
  +](#theme_minimal-)
- [<span class="toc-section-number">19</span> labs(title = “FCR
  Trajectory by Treatment (China
  Trial)”,](#labstitle--fcr-trajectory-by-treatment-china-trial)
- [<span class="toc-section-number">20</span> x = “Day”, y = “Feed
  Conversion Ratio”)](#x--day-y--feed-conversion-ratio)
  - [<span class="toc-section-number">20.1</span> 6. Economic Analysis
    (China Market)](#6-economic-analysis-china-market)
    - [<span class="toc-section-number">20.1.1</span> 6.1 Cost-Benefit
      Analysis](#61-cost-benefit-analysis)
    - [<span class="toc-section-number">20.1.2</span> 9.2 Add Trial
      Results to NotebookLM](#92-add-trial-results-to-notebooklm)
  - [<span class="toc-section-number">20.2</span> 10. Session
    Info](#10-session-info)
  - [<span class="toc-section-number">20.3</span> 11. Next
    Steps](#11-next-steps)
...
path_07 \<- qproj::path_source(“07-experimental-design”) path_08 \<-
qproj::path_source(“08-manuscript-draft”)
...
“Microbiome Shannon Index”), unit = c(“kg feed/kg gain”, “g/day”, “%”,
“score”, “villus height:crypt depth”, “index”), frequency = c(“Weekly”,
“Daily”, “Daily”, “At harvest”, “At harvest”, “Endpoint”) )
...
“Mortality reduction”), cost_rmb = c(0.3, 0.2, 0.1, 0.2, -2.0, -1.5),
\# - = savings unit = c(“¥/bird”, “¥/bird”, “¥/bird”, “¥/bird”, “¥/FCR
point”, “¥/%”) )

total_cost \<- sum(cost_benefit_cn$cost_rmb[cost_benefit_cn$cost_rmb \>
0\]) total_savings \<-
abs(sum(cost_benefit_cn$cost_rmb[cost_benefit_cn$cost_rmb \< 0\]))

ROI_cn \<- (total_savings - total_cost) / total_cost \* 100

knitr::kable(cost_benefit_cn, caption = “Cost-Benefit Analysis (China,
per 1000 birds)”)
